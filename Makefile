...
k8s: validate
	...
	$(PACKER_BINARY) build -debug $(foreach packerVar,$(PACKER_VARIABLES), $(if $($(packerVar)),--var $(packerVar)='$($(packerVar))',)) eks-worker-ubuntu.json

.PHONY: 1.13
1.13: validate
	$(MAKE) version=1.13.12 kubernetes_build_date=2020-01-22 k8s

.PHONY: 1.14
1.14: validate
	$(MAKE) version=1.14.9 kubernetes_build_date=2020-01-22 k8s
...
.PHONY: latest
latest: validate
	$(MAKE) version=latest kubernetes_build_date=2020-02-22 k8s
